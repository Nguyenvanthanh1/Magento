...
namespace Tigren\Customer\Setup\Patch\Data;
...
class AddAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'is_created_question', [
            'type' => 'varchar',
            'input' => 'text',
            'label' => 'Is Created Question',
            'required' => true,
            'default' => 'False',
            'visible' => true,
            'user_defined' => true,
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'is_created_question');
